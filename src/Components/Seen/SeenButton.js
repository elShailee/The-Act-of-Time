...
export default function SeenButton() {
	...
	const atListOneWindowOpen = isSeenWindowMounted || isCraftingWindowMounted;
	...
	useButtonAnimation(seenButtonShouldMoveUp, seenButtonShouldMoveDown, atListOneWindowOpen);
	const onSeenClick = () => {
